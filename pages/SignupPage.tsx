...
const SignupPage: React.FC<SignupPageProps> = ({ 
  ...
  return (
    <div 
      ...
      aria-modal="true"
    >
      <div className="relative bg-hegira-white w-full max-w-lg rounded-2xl shadow-2xl border border-hegira-navy/10 overflow-hidden transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear">
        <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar-modal">
            <div className="text-center mb-6">
                <Logo className="text-3xl sm:text-4xl text-hegira-turquoise font-bold mb-2" />
                <h1 id="signup-modal-title" className="text-xl sm:text-2xl font-semibold text-hegira-navy">{modalTitle}</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                 <div>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id={`signup-name-${role}`} value={name} onChange={(e) => setName(e.target.value)} required 
                               className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-3 bg-white text-hegira-navy border rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors placeholder-gray-400 text-sm ${nameError ? 'border-red-500 ring-red-500' : 'border-gray-300'}`}
                    ...
                    <label htmlFor={`signup-email-${role}`} className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Email</label>
                     <div className="relative">
                        ...
                        <input type="email" id={`signup-email-${role}`} value={email} onChange={(e) => setEmail(e.target.value)} required 
                               className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-3 bg-white text-hegira-navy border rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors placeholder-gray-400 text-sm ${emailError ? 'border-red-500 ring-red-500' : 'border-gray-300'}`}
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type={showPassword ? "text" : "password"} id={`signup-password-${role}`} value={password} onChange={(e) => setPassword(e.target.value)} required 
                               className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-10 bg-white text-hegira-navy border rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors placeholder-gray-400 text-sm ${passwordError ? 'border-red-500 ring-red-500' : 'border-gray-300'}`}
                 ...
                 <div>
                    ...
                    <div className="relative">
                        ...
                        <input type={showConfirmPassword ? "text" : "password"} id={`signup-confirm-password-${role}`} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required 
                               className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-10 bg-white text-hegira-navy border rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors placeholder-gray-400 text-sm ${confirmPasswordError ? 'border-red-500 ring-red-500' : 'border-gray-300'}`}
                ...
                <p className="text-xs text-gray-500">
                    Dengan mendaftar, Anda menyetujui <a href="#" className="text-hegira-turquoise hover:underline">Syarat Layanan</a> dan <a href="#" className="text-hegira-turquoise hover:underline">Kebijakan Privasi</a> kami.
                </p>
                ...
                className={`w-full flex justify-center items-center py-2.5 sm:py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold 
                                text-white bg-hegira-turquoise hover:bg-hegira-turquoise/90 
                                focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-hegira-white focus:ring-hegira-yellow
            ...
            <p className="mt-6 text-center text-xs text-gray-500">
                ...
                <button 
                    ...
                    className="font-medium text-hegira-turquoise hover:text-hegira-turquoise/80"
                >
                    Masuk sebagai {role}
                </button>
            </p>
      ...
      <style>{`
        ...
        .custom-scrollbar-modal::-webkit-scrollbar-thumb {
          background: var(--hegira-turquoise); /* Use hegira turquoise for thumb */
          border-radius: 3px;
        }
