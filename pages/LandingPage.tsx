...
const LandingPage: React.FC<LandingPageProps> = ({ heroEvents, featuredEvents, onNavigate, onOpenLoginModal, openSubscriptionModal }) => {
  ...
  return (
    <>
      ...
      <section id="events" className="py-16 md:py-24 bg-hegira-card-bg  animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-0 sm:px-6 lg:px-8"> {/* Adjusted padding for full-bleed scroll */}
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 md:mb-16  px-4 sm:px-0"> {/* Padding for title section */}
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-jakarta text-hegira-deep-navy text-center md:text-left">Temukan Event <span className="text-gradient">Menarik</span></h2>
              <p className="text-neutral-700 mt-2 text-center md:text-left">Jelajahi berbagai acara terbaru dan paling populer.</p>
            </div>
            <button 
              onClick={() => onNavigate('events')} 
              className="mt-4 md:mt-0 text-hegira-gradient-start hover:text-hegira-gradient-mid font-semibold transition-colors duration-300 group flex items-center"
            >
      ...
      <section id="about-hegira" className="py-16 md:py-24 bg-hegira-chino/20 animate-on-scroll fade-in-up" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="mb-4">
            <span className="bg-hegira-turquoise/20 text-hegira-turquoise font-semibold px-4 py-1.5 rounded-full text-xs inline-block">
              ABOUT US
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold font-jakarta text-hegira-deep-navy mb-8">
            Apa itu <span className="text-hegira-turquoise">Hegira?</span>
          </h2>
      ...
      <section id="create-your-event" className="py-16 md:py-24 bg-hegira-white animate-on-scroll fade-in-up" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16 ">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-jakarta text-hegira-deep-navy">
              Buat Event <span className="text-gradient">Impian Anda</span>
            </h2>
            <p className="text-lg text-gray-600 mt-3 max-w-3xl mx-auto">
              hegira menyediakan platform lengkap untuk membantu Anda merencanakan, mempromosikan, dan mengelola event dengan sukses. Mulai dari konser, seminar, hingga workshop, semua jadi lebih mudah.
            </p>
          </div>
          ...
          <div className="text-center ">
            <button 
              ...
              className="bg-hegira-yellow text-hegira-navy font-bold py-3.5 px-8 rounded-lg text-lg 
      ...
      <section id="business-matching" className="py-16 md:py-24 bg-hegira-chino/20 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16 ">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-jakarta text-hegira-deep-navy">
          ...
          <div className="text-center ">
            <button 
              ...
              className="bg-hegira-turquoise text-white font-bold py-3.5 px-8 rounded-lg text-lg
                         hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg 
                         inline-flex items-center gap-2.5"
            >
      ...
      <section id="articles" className="py-16 md:py-24 bg-hegira-white animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16 ">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-jakarta text-hegira-deep-navy">
          ...
          <div className="text-center ">
            <button 
              ...
              className="text-hegira-gradient-start hover:text-hegira-gradient-mid font-semibold transition-colors duration-300 group flex items-center mx-auto"
            >
      ...
      <section id="newsletter" className="py-16 md:py-24 bg-gradient-to-r from-hegira-turquoise to-hegira-yellow animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center ">
          <Zap size={48} className="mx-auto mb-4 text-white" />
          <h2 className="text-3xl md:text-4xl font-bold font-jakarta text-hegira-white mb-4">
            Jangan Ketinggalan Update Terbaru dari Hegira!
          </h2>
          <p className="text-lg text-hegira-light-bg/90 mb-8 max-w-xl mx-auto">
          ...
          <form onSubmit={handleNewsletterSubmit} className="max-w-lg mx-auto flex flex-col sm:flex-row gap-3">
            ...
            <input
              ...
              className="flex-grow py-3 px-4 rounded-lg border border-transparent 
                         focus:ring-2 focus:ring-hegira-navy focus:border-hegira-navy 
                         text-base shadow-md text-hegira-deep-navy"
              aria-label="Alamat email untuk newsletter"
            />
            <button
              type="submit"
              className="bg-hegira-navy text-white font-semibold py-3 px-6 rounded-lg 
