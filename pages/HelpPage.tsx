    ...
    <div className="border-b border-gray-200 last:border-b-0">
      <h3>
        <button
          ...
          className="flex justify-between items-center w-full py-5 text-left text-hegira-navy hover:text-hegira-turquoise focus:outline-none focus-visible:ring focus-visible:ring-hegira-yellow focus-visible:ring-opacity-75 transition-colors group"
          aria-expanded={isOpen}
          aria-controls={`faq-answer-${id}`}
        >
          <span className="font-semibold font-jakarta text-base sm:text-lg group-hover:text-hegira-turquoise">{question}</span>
          {isOpen ? <ChevronUp size={24} className="text-hegira-turquoise flex-shrink-0" /> : <ChevronDown size={24} className="text-gray-500 group-hover:text-hegira-turquoise flex-shrink-0" />}
        </button>
      </h3>
      {isOpen && (
    ...
    <div className="bg-gray-50 min-h-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        <header className="text-center mb-10 md:mb-16">
          <HelpCircle size={48} className="mx-auto text-hegira-turquoise mb-4" />
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-jakarta font-bold text-hegira-navy">Pusat Bantuan Hegira</h1>
        ...
        <div className="max-w-3xl mx-auto">
          <section aria-labelledby="faq-heading" className="bg-hegira-white p-6 sm:p-8 md:p-10 rounded-xl border border-hegira-navy/10">
            <h2 id="faq-heading" className="text-2xl sm:text-3xl font-jakarta font-semibold text-hegira-navy mb-6 sm:mb-8">
              Pertanyaan Umum (FAQ)
            </h2>
          ...
          <section aria-labelledby="contact-support-heading" className="mt-12 md:mt-16 text-center bg-hegira-white p-6 sm:p-8 md:p-10 rounded-xl border border-hegira-navy/10">
            <Mail size={40} className="mx-auto text-hegira-turquoise mb-4" />
            <h2 id="contact-support-heading" className="text-2xl sm:text-3xl font-jakarta font-semibold text-hegira-navy mb-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-hegira-turquoise text-hegira-white font-semibold px-6 py-3 sm:px-8 sm:py-3.5 rounded-lg hover:bg-opacity-90 transition-all text-base sm:text-lg shadow-md hover:shadow-lg transform hover:scale-105"
            >
              <Mail size={20} />
              Email Tim Support
            </a>
