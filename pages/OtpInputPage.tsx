...
const OtpInputPage: React.FC<OtpInputPageProps> = ({ 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-hegira-auth-background p-4">
       <button 
          onClick={handleCloseAndGoToLanding}
          className="absolute top-6 left-6 text-xs text-hegira-auth-text/70 hover:text-hegira-auth-text inline-flex items-center z-20"
      ...
      <div className="relative bg-hegira-white w-full max-w-md rounded-2xl shadow-2xl border border-hegira-navy/10 p-8 sm:p-10 text-center transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear">
        ...
        <h1 className="text-2xl font-bold text-hegira-navy mb-2">Masukkan Kode OTP</h1>
