...
const PortfolioCard: React.FC<PortfolioCardProps> = ({ imageUrl, eventName, description }) => (
  <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
    ...
    <div className="p-6">
      <h4 className="text-xl font-jakarta font-semibold text-hegira-navy mb-2">{eventName}</h4>
...
const CreatorFeatureCard: React.FC<CreatorFeatureCardProps> = ({ icon: Icon, title, description }) => (
  <div className="bg-gradient-to-br from-hegira-turquoise/5 to-hegira-yellow/5 p-6 rounded-xl border border-hegira-turquoise/20 text-center hover:shadow-lg transition-shadow duration-300">
    <div className="inline-block p-4 bg-hegira-turquoise text-white rounded-full mb-4">
      <Icon size={32} />
    </div>
    <h4 className="text-lg font-jakarta font-semibold text-hegira-navy mb-2">{title}</h4>
...
const CreateEventInfoPage: React.FC<CreateEventInfoPageProps> = ({ 
  ...
  return (
    <div className="bg-hegira-light-bg">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-hegira-navy to-hegira-turquoise py-20 md:py-32 text-white text-center animate-on-scroll fade-in-up" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <Zap size={64} className="mx-auto mb-6 text-hegira-yellow" />
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-jakarta font-bold mb-4">Wujudkan Event <span className="text-hegira-yellow">Impian Anda</span></h1>
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto mb-8">
            hegira menyediakan platform lengkap untuk membantu Anda merencanakan, mempromosikan, dan mengelola event dengan sukses dan mudah.
          </p>
          <button 
            onClick={handleCTAClick}
            className="bg-hegira-yellow text-hegira-navy font-bold py-3 px-8 rounded-lg text-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-xl"
          >
            {ctaButtonText}
          </button>
        </div>
      ...
      {/* About hegira for Creators Section */}
      <section className="py-16 md:py-24 bg-hegira-white animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-jakarta font-bold text-hegira-deep-navy">
              Mengapa Memilih <span className="text-hegira-turquoise">hegira</span> untuk Event Anda?
            </h2>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureItem
              ...
              iconBgClass="bg-hegira-turquoise/20"
              iconColorClass="text-hegira-turquoise"
            />
            <FeatureItem
              icon={Users2}
              ...
              iconBgClass="bg-hegira-yellow/20"
              iconColorClass="text-hegira-yellow"
            />
            <FeatureItem
              icon={Briefcase}
              ...
              iconBgClass="bg-hegira-chino/20"
              iconColorClass="text-hegira-chino"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-50 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
              Lihat bagaimana hegira telah membantu berbagai event mencapai kesuksesan.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-hegira-white animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-jakarta font-bold text-hegira-deep-navy">
              Fitur <span className="text-hegira-turquoise">Unggulan</span> Platform Kami
            </h2>
            <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-hegira-chino/20 to-hegira-chino/50 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center ">
          <Award size={48} className="mx-auto mb-6 text-hegira-yellow" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-jakarta font-bold text-hegira-deep-navy mb-4">
            Langkah Mudah Membuat Event Anda di hegira
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-hegira-turquoise">
              <h3 className="text-xl font-jakarta font-semibold text-hegira-navy mb-2"><span className="text-hegira-turquoise font-bold text-2xl mr-2">1.</span>Daftar Akun</h3>
              <p className="text-sm text-gray-600">Buat akun Event Creator atau Organisasi Anda di hegira. Prosesnya cepat dan mudah.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-hegira-yellow">
              <h3 className="text-xl font-jakarta font-semibold text-hegira-navy mb-2"><span className="text-hegira-yellow font-bold text-2xl mr-2">2.</span>Buat Event</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-hegira-navy">
              <h3 className="text-xl font-jakarta font-semibold text-hegira-navy mb-2"><span className="text-hegira-navy font-bold text-2xl mr-2">3.</span>Publikasi & Kelola</h3>
          ...
          <button
            onClick={handleCTAClick}
            className="bg-hegira-turquoise text-white font-bold py-4 px-10 rounded-lg text-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center justify-center gap-2 mx-auto"
          >
