    ...
    <div className="bg-gray-50 min-h-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <header className="mb-10 md:mb-16 text-center">
          <BookOpen size={48} className="mx-auto text-hegira-turquoise mb-4" />
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-jakarta text-hegira-navy">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            ...
            <div>
              <button 
                ...
                className="w-full md:w-auto flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50"
            ...
            <div id="article-filters-content" className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in">
              <div>
                ...
                <select
                  ...
                  className="w-full py-2.5 px-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors bg-white text-sm"
              ...
              <ul className="inline-flex items-center -space-x-px shadow-sm">
                <li>
                  <button
                    ...
                    className="py-2 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-hegira-turquoise disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50"
                ...
                {pageNumbers.map(number => (
                  <li key={number}>
                    <button
                      ...
                      className={`py-2 px-4 leading-tight border transition-colors focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50
                        ${currentPage === number 
                          ? 'text-hegira-turquoise bg-hegira-turquoise/10 border-hegira-turquoise font-semibold z-10' 
                          : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-100 hover:text-hegira-turquoise'
                        }`}
                ...
                <li>
                  <button
                    ...
                    className="py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-hegira-turquoise disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50"
