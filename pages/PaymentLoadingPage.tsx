...
const PaymentLoadingPage: React.FC<PaymentLoadingPageProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-hegira-white text-hegira-navy p-4 text-center">
      ...
      <button
        ...
        className="mt-12 flex items-center text-sm text-hegira-turquoise hover:text-hegira-navy font-semibold transition-colors group border border-hegira-turquoise px-4 py-2 rounded-lg hover:bg-hegira-turquoise/10"
      >
