...
const TicketDisplayPage: React.FC<TicketDisplayPageProps> = ({ transactionData, onNavigate }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-hegira-navy to-hegira-turquoise min-h-screen py-8 md:py-12 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 md:mb-12">
            <button
                ...
                className="flex items-center text-sm text-hegira-yellow hover:text-opacity-80 font-semibold transition-colors group mb-4 sm:mb-0 self-start sm:self-center"
            >
            ...
            <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-hegira-yellow text-hegira-navy font-bold py-2.5 px-6 rounded-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-60 disabled:cursor-not-allowed self-end sm:self-center"
            >
