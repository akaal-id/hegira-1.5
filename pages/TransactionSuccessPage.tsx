      ...
      <div className="bg-gray-50 min-h-screen py-8 md:py-12 pb-48 lg:pb-12"> {/* Increased mobile bottom padding */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:flex lg:gap-8">
            <div className="lg:w-2/3 bg-white p-6 md:p-8 rounded-xl border border-hegira-navy/10 mb-8 lg:mb-0">
              <h2 className="text-2xl font-jakarta font-bold text-hegira-navy mb-6 border-b pb-3">Detail E-Tiket Anda</h2>

              <div className="mb-6 p-4 border border-dashed border-gray-300 rounded-lg text-center bg-gray-50">
                <h3 className="text-lg font-jakarta font-medium text-hegira-navy mb-2">Pindai untuk Masuk Event</h3>
                <QrCode size={128} className="mx-auto text-hegira-navy my-4" /> 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mb-6 text-sm">
                <div>
                  ...
                  <span className="text-hegira-navy font-medium">{transactionId}</span>
                </div>
                <div>
                  <strong className="block text-gray-500">ID Pesanan:</strong>
                  <span className="text-hegira-navy font-medium">{orderId}</span>
                </div>
              </div>
              ...
              <div className="mb-6 border-t pt-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="text-lg font-jakarta font-semibold text-hegira-navy">Informasi Event</h3>
                    <p className="text-xl font-medium font-jakarta text-hegira-turquoise mt-1">{event.name}</p>
                  </div>
                  <button
                    onClick={handleAddToCalendar}
                    disabled={!canAddToCalendar}
                    className="flex items-center justify-center gap-1.5 text-xs bg-hegira-turquoise text-white font-semibold py-2 px-3 rounded-lg hover:bg-opacity-80 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed whitespace-nowrap"
                ...
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <a 
                    ...
                    className="text-hegira-turquoise hover:underline"
                  >
                    {event.location}
                  </a>
                </div>
              ...
              <div className="mb-6 border-t pt-4">
                <h3 className="text-lg font-jakarta font-semibold text-hegira-navy mb-3">Data Pemesan</h3>
              ...
              {totalTicketsPurchased > 0 && formData.additionalTicketHolders && formData.additionalTicketHolders.length > 0 && (
                <div className="mb-6 border-t pt-4">
                  <h3 className="text-lg font-jakarta font-semibold text-hegira-navy mb-4 flex items-center">
                    <Ticket size={20} className="mr-2 text-hegira-turquoise" />
                    ...
                    {formData.additionalTicketHolders.map((holder, index) => {
                      ...
                      return (
                        <div key={index} className="p-3 bg-gray-50 rounded-md border border-gray-200 text-sm">
                          <p className="font-semibold font-jakarta text-hegira-navy">Tiket #{index + 1}</p>
              ...
              <div className="border-t pt-4">
                <h3 className="text-lg font-jakarta font-semibold text-hegira-navy mb-3 flex items-center">
                  <Info size={20} className="mr-2 text-hegira-turquoise" /> Syarat & Ketentuan Penting
                </h3>
            ...
            <div className="hidden lg:block lg:w-1/3">
              <div className="sticky top-24 bg-white rounded-xl border border-hegira-navy/10 overflow-hidden">
                 {/* Event Poster Image */}
                ...
                <div className="p-6">
                  <h3 className="text-xl font-jakarta font-semibold text-hegira-navy mb-4">Detail Pesanan</h3>
                  <div className="space-y-2 mb-4 text-sm">
                    ...
                    <div className="border-t pt-2 mt-2 flex justify-between items-center">
                      <span className="text-base font-semibold text-hegira-navy">Total Dibayar</span>
                  ...
                  <div className="space-y-3 mt-6">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-hegira-yellow text-hegira-navy font-semibold py-3 px-4 rounded-lg hover:bg-opacity-90 transition-colors"
                    >
                      <Eye size={18} /> Lihat Tiket-ku
                    </button>
                    <button
                      onClick={handleDownloadTicket} 
                      className="w-full flex items-center justify-center gap-2 bg-hegira-turquoise text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-opacity-80 transition-colors"
                    >
                      <Download size={18} /> Unduh Tiket (Simulasi)
                    </button>
                    <button
                      onClick={handleSendToEmail}
                      className="w-full flex items-center justify-center gap-2 bg-hegira-navy text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-opacity-80 transition-colors"
                    >
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <p className="text-sm font-jakarta font-semibold text-hegira-navy mb-2 text-center">Butuh Bantuan terkait Event?</p>
                  ...
                  <button 
                    ...
                    className="mt-8 w-full text-center text-sm text-hegira-turquoise hover:underline"
                  >
                    Kembali ke Beranda
                  </button>
                </div>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white p-3 border-t border-gray-200 shadow-lg space-y-2">
          <div className="flex justify-between items-center">
              <div>
                  ...
                  <p className="text-lg font-bold text-hegira-yellow">{formatCurrency(totalPrice)}</p>
              </div>
              <button
                  onClick={handleViewMyTickets}
                  className="bg-hegira-yellow text-hegira-navy font-semibold py-2.5 px-4 rounded-lg hover:bg-opacity-90 transition-colors flex items-center justify-center gap-1.5 text-sm"
              >
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
              <button
                onClick={handleDownloadTicket}
                className="w-full flex items-center justify-center gap-1 bg-hegira-turquoise text-white font-medium py-2 px-2 rounded-md hover:bg-opacity-80 transition-colors"
              >
                <Download size={14} /> Unduh (Simulasi)
              </button>
              <button
                onClick={handleSendToEmail}
                className="w-full flex items-center justify-center gap-1 bg-hegira-navy text-white font-medium py-2 px-2 rounded-md hover:bg-opacity-80 transition-colors"
              >
              ...
              <button
                onClick={() => onNavigate('landing')}
                className="w-full flex items-center justify-center gap-1 bg-gray-100 text-hegira-navy font-medium py-2 px-2 rounded-md hover:bg-gray-200 transition-colors"
              >
