...
const BusinessMatchingDashboardPage: React.FC<BusinessMatchingDashboardPageProps> = ({
  ...
  const renderBusinessMatchingDashboardContent = () => {
    switch (activeView) {
      ...
      default:
        return <div className="p-6"><h2 className="text-2xl font-semibold text-hegira-navy mb-4">Dasbor Organisasi</h2><p className="text-gray-700">Selamat datang! Pilih menu dari sidebar untuk mengelola aktivitas business matching Anda.</p></div>;
    }
  };
