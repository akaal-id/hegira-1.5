  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy">Layanan Saya</h1>
        <button
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200 mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-hegira-turquoise focus:border-hegira-turquoise text-sm bg-white"
          />
        </div>
      </div>
            ...
            <div key={service.id} className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
              <div className="p-5 flex-grow">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-lg font-semibold text-hegira-deep-navy group-hover:text-hegira-turquoise transition-colors duration-200 leading-tight flex-grow mr-2" title={service.name}>
                    {service.name}
                  </h3>
                ...
                <p className="text-xs font-medium text-hegira-turquoise bg-hegira-turquoise/10 px-2 py-0.5 rounded-full inline-block mb-2">{service.category}</p>
