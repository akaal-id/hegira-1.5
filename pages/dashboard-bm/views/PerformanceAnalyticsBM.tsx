...
const PerformanceAnalyticsBM: React.FC = () => {
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy mb-6">Analitik Performa Business Matching</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {summaryData.map(item => (
            <div key={item.label} className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                ...
                <p className="text-2xl font-bold text-hegira-deep-navy">{item.value}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
            <h2 className="text-md font-semibold text-hegira-deep-navy mb-3 flex items-center">
                <LineChart size={18} className="mr-2 text-hegira-turquoise"/> Tren Kunjungan Profil (30 Hari Terakhir)
            </h2>
            <PlaceholderChart title="Grafik Kunjungan Profil"/>
        </div>
        <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
            <h2 className="text-md font-semibold text-hegira-deep-navy mb-3 flex items-center">
                <BarChartHorizontalBig size={18} className="mr-2 text-hegira-turquoise"/> Sumber Permintaan Masuk
            </h2>
         ...
         <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm lg:col-span-2">
            <h2 className="text-md font-semibold text-hegira-deep-navy mb-3 flex items-center">
                <Users size={18} className="mr-2 text-hegira-turquoise"/> Demografi Pengunjung Profil (Segera Hadir)
            </h2>
