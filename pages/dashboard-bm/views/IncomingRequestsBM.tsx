...
const IncomingRequestsBM: React.FC = () => {
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy mb-6">Permintaan Masuk</h1>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                  <div className="flex-grow min-w-0">
                    <div className="flex items-center mb-0.5">
                       ...
                       <p className="text-sm font-semibold text-hegira-turquoise truncate" title={req.subject}>{req.subject}</p>
                    </div>
