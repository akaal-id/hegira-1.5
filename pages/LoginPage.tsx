...
const LoginPage: React.FC<LoginPageProps> = ({ 
  ...
  return (
    <div 
      ...
      aria-modal="true"
    >
      <div className="relative bg-hegira-white w-full max-w-md rounded-2xl shadow-2xl border border-hegira-navy/10 overflow-hidden transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear">
        <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8">
            ...
            <h1 id="login-modal-title" className="text-xl sm:text-2xl font-semibold text-hegira-navy">{modalTitle}</h1>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-3 bg-white text-hegira-navy border 
                                rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors
            ...
            <div>
                ...
                <input
                    ...
                    className={`w-full py-2 sm:py-2.5 pl-9 sm:pl-10 pr-10 bg-white text-hegira-navy border 
                                rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors
            ...
            <div className="text-right">
                <a href="#" className="text-xs font-medium text-hegira-turquoise hover:text-hegira-turquoise/80">
                Lupa password?
                </a>
            </div>
            ...
            Belum punya akun?{' '}
            <button onClick={onSwitchToSignup} className="font-medium text-hegira-turquoise hover:text-hegira-turquoise/80">
                Daftar sebagai {role}
            </button>
            </p>
        </div>
