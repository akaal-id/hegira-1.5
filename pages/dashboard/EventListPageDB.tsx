  ...
  const renderPageNumbers = () => {
    ...
    return pageNumbersToDisplay.map((number, index) => 
        typeof number === 'string' ? (
            ...
            className={`px-3 py-1 mx-1 rounded-md text-sm transition-colors focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50
                ${currentPage === number 
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 px-4 pt-4 sm:px-0 sm:pt-0">
        <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy mb-4 sm:mb-0">Daftar Event</h1>
        <button
          onClick={() => onSwitchView('createEventView')} 
          className="bg-hegira-turquoise text-white font-semibold py-2.5 px-5 rounded-lg hover:bg-hegira-turquoise/90 transition-colors flex items-center gap-2"
        >
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200 mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <select className="w-full py-2 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 text-sm text-gray-500 bg-white">
