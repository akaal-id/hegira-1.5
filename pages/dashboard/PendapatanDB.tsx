...
const PendapatanDB: React.FC<PendapatanDBProps> = ({ selectedEvent }) => {
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy mb-2">Pendapatan Event</h1>
      <p className="text-sm text-gray-600 mb-6">Event: <strong className="text-hegira-turquoise">{selectedEvent.name}</strong></p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        <div className="flex items-center mb-4 pb-2 border-b border-gray-100">
            <CreditCard size={20} className="mr-3 text-hegira-turquoise" />
            <h2 className="text-xl font-semibold text-hegira-deep-navy">Rekening Bank Anda & Penarikan Dana</h2>
        </div>
        <div className="space-y-4 max-w-xl">
          <div>
            ...
            <input
              ...
              className="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors bg-white"
          ...
          <div>
            ...
            <div className="relative">
                ...
                className="w-full py-2 pl-9 pr-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 transition-colors appearance-none bg-white"
                >
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-hegira-yellow text-hegira-navy font-bold py-2.5 px-6 rounded-lg hover:bg-opacity-90 transition-colors shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <DollarSign size={18} /> Tarik Dana
            </button>
             <p className="text-xs text-gray-500 mt-2">
              Saldo yang dapat ditarik: <strong className="text-hegira-deep-navy">{formatCurrency(pendapatanBersih)}</strong>. 
