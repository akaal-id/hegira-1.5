...
const TiketKuponDB: React.FC<TiketKuponDBProps> = ({ allEvents, currentEventContext, onSetContextEvent, onSwitchView }) => {
      ...
      <div className="mt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600 bg-white p-4 rounded-b-lg border-t border-gray-200">
        ...
        <div className="flex items-center space-x-1">
          <button
            ...
            className="px-3 py-1.5 rounded-md bg-white text-gray-500 hover:bg-gray-100 border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50"
          ...
          {pageNumbers.map((number, index) =>
            typeof number === 'string' ? (
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-md transition-colors border focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50
                  ${currentPage === number 
                    ? 'bg-hegira-turquoise text-white font-semibold border-hegira-turquoise' 
  ...
  if (!currentEventContext) {
    return (
      <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full space-y-6 text-center">
        ...
        <h1 className="text-xl font-semibold text-hegira-deep-navy">Pilih Event Terlebih Dahulu</h1>
        ...
        <button
            ...
            className="bg-hegira-turquoise text-white font-semibold py-2.5 px-6 rounded-lg hover:bg-opacity-90 transition-colors flex items-center gap-2 mx-auto"
        >
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full space-y-2">
      <h1 className="text-2xl sm:text-3xl font-bold text-hegira-deep-navy">Manajemen Tiket & Kupon</h1>
      <p className="text-sm text-gray-600 mb-6">
        Event: <strong className="text-hegira-turquoise">{currentEventContext.name}</strong>
      </p>
        ...
        <nav className="-mb-px flex space-x-6" aria-label="Tabs">
            <button
              ...
              className={`whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm
                  ${activeTab === 'tiket' 
                  ? 'border-hegira-turquoise text-hegira-turquoise' 
          ...
          <div className="flex items-center gap-4"> 
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 text-sm bg-white"
              />
            </div>
            <button
              onClick={handleAddTicketClick}
              className="bg-hegira-turquoise text-white font-semibold py-2 px-4 rounded-lg hover:bg-opacity-90 transition-colors flex items-center gap-2 text-sm flex-shrink-0"
            >
        ...
        <div className="space-y-6 bg-white p-4 rounded-b-lg border border-t-0 border-gray-200">
           <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-hegira-turquoise text-white font-semibold py-2 px-4 rounded-lg transition-colors flex items-center gap-2 text-sm flex-shrink-0 hover:bg-opacity-90"
            >
