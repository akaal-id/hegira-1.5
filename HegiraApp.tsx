...
const sampleEvents: EventData[] = baseEvents.map((event) => ({
  ...event,
  ticketCategories: event.ticketCategories.map((tc) => ({
    ...
    useEventSchedule: tc.useEventSchedule ?? true,
    ticketStartDate: tc.ticketStartDate || undefined,
    ticketEndDate: tc.ticketEndDate || undefined,
    ticketStartTime: tc.ticketStartTime || undefined,
    ticketEndTime: tc.ticketEndTime || undefined,
    ticketIsTimeRange: tc.ticketIsTimeRange ?? true,
...
const HegiraApp: React.FC = () => {
  ...
  const [allEventsData, setAllEventsData] = useState<EventData[]>(baseEvents);
