...
import DashboardPage, {
  DashboardViewId as DashboardViewIdCreatorVisitor,
} from "./pages/DashboardPage"; // Renamed import
import BusinessMatchingDashboardPage, {
  DashboardViewIdBM,
} from "./pages/dashboard-bm/BusinessMatchingDashboardPage"; // New BM Dashboard
import EventDetailPage from "./pages/EventDetailPage";
import CheckoutPage from "./pages/CheckoutPage";
import PaymentLoadingPage from "./pages/PaymentLoadingPage";
import TransactionSuccessPage from "./pages/TransactionSuccessPage";
...
interface LandingPageProps {
  ...
  openSubscriptionModal: () => void; // Add this line
}
export interface TicketCategory {
  id: string;
  name: string;
...
export const mapAuthRoleToUserRole = (
  authRole: AuthRoleType | UserRole
): UserRole => {
  if (
    authRole === "visitor" ||
    authRole === "creator" ||
...
=======
    processedTimeDisplay = processedTimeDisplay
      .replace(timezoneRegex, "")
      .trim();
  }
...
=======
const sampleEventsInitial: (Omit<EventData, "ticketCategories"> & {
  ticketCategories: Array<
    Partial<TicketCategory> & {
      id: string;
      name: string;
      price: number;
      maxQuantity?: number;
...
})[] = [
  {
    id: 1,
    category: "B2C",
    name: "Local Soundscape: Indie Music Night",
    location: "Rooftop ITC Depok",
    posterUrl:
      "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    coverImageUrl:
      "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/06/28 - 2025/06/29",
    timeDisplay: "15:00 - 22:00",
    timezone: "WIB",
    fullDescription:
      "Nikmati malam penuh alunan musik indie dari band-band lokal berbakat di Depok. Suasana rooftop yang cozy dengan city view menawan. Tersedia berbagai tenant makanan dan minuman.",
    ticketCategories: [
      {
        id: "regular",
        name: "Regular",
        price: 75000,
        description: "Akses masuk reguler.",
      ...
      },
      {
        ...
        name: "VIP",
        price: 150000,
        description: "Akses VIP, free drink, dan merchandise.",
        availabilityStatus: "almost-sold",
        useEventSchedule: true,
        maxQuantity: 50,
        ticketsPurchased: 48,
      },
    ...
    ageRestriction: "18+",
    arrivalInfo:
      "Pintu masuk dari Lobby Utara ITC Depok, naik lift ke lantai paling atas.",
    status: "Aktif",
    theme: "Konser Musik",
    address:
      "Jl. Margonda Raya No.56, Depok, Kec. Pancoran Mas, Kota Depok, Jawa Barat 16431",
    termsAndConditions:
      "Dilarang membawa makanan dan minuman dari luar. Dilarang membawa senjata tajam dan obat-obatan terlarang. Tiket yang sudah dibeli tidak dapat dikembalikan.",
    eventSlug: "local-soundscape-depok",
    narahubungName: "Panitia Soundscape",
    narahubungPhone: "081200001111",
    narahubungEmail: "info@localsound.id",
  },
  {
    id: 2,
    category: "B2B",
    ...
    coverImageUrl:
      "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/07/19",
    timeDisplay: "09:00 - 17:00",
    timezone: "WIB",
    fullDescription:
      "Konferensi tahunan untuk para content creator, influencer, dan agensi. Sesi networking, workshop, dan diskusi panel dengan para ahli di industri kreatif digital.",
    ticketCategories: [
      {
        id: "early-bird-creator",
        name: "Early Bird Creator Pass",
        price: 200000,
        description: "Akses semua sesi, berlaku hingga 30 Juni.",
      ...
      },
      {
        ...
        name: "Creator Pass",
        price: 250000,
        description: "Akses semua sesi konferensi.",
        availabilityStatus: "available",
        useEventSchedule: false,
        ticketStartDate: "2025-07-01",
        ticketEndDate: "2025-07-19",
        ticketStartTime: "08:00",
        ticketEndTime: "18:00",
      ...
      },
      {
        ...
        name: "Business Pass",
        price: 500000,
        description: "Akses semua sesi + area networking B2B.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 150,
        ticketsPurchased: 0,
    ...
    organizerLogoUrl: "/image/hegiralogo.png",
    summary:
      "Konferensi networking dan workshop untuk content creator & influencer.",
    googleMapsQuery: "Margo City, Depok",
    parkingAvailable: true,
    ageRestriction: "17+",
    arrivalInfo: "Registrasi di Main Atrium Margo City, lantai dasar.",
    status: "Aktif",
    theme: "Konferensi & Workshop",
    address:
      "Jl. Margonda Raya No.358, Kemiri Muka, Kecamatan Beji, Kota Depok, Jawa Barat 16423",
    eventSlug: "creator-connect-2025",
  ...
  },
  {
    ...
    posterUrl:
      "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    coverImageUrl:
      "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/08/25 - 2025/08/26",
    timeDisplay: "08:30 - 17:00",
    timezone: "WIB",
    fullDescription:
      "Forum strategis yang mempertemukan perwakilan pemerintah, pelaku UMKM, dan penyedia teknologi untuk akselerasi transformasi digital UMKM di Indonesia. Diskusi kebijakan, showcase solusi, dan business matching.",
    ticketCategories: [
      {
        id: "umkm-delegate",
        name: "Delegasi UMKM",
        price: 0,
        description: "Gratis untuk UMKM terpilih (perlu registrasi & seleksi).",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 500,
      ...
      {
        id: "gov-delegate",
        name: "Delegasi Pemerintah",
        price: 0,
        description: "Khusus perwakilan instansi pemerintah.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 200,
        ticketsPurchased: 50,
      ...
      {
        id: "tech-provider",
        name: "Penyedia Teknologi/Umum",
        price: 750000,
        description: "Akses ke semua sesi dan area pameran.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 100,
        ticketsPurchased: 30,
    ...
    eventSlug: "forum-umkm-digital-2025",
  ...
  },
  {
    id: 4,
    category: "B2C",
    name: 'Pameran Seni Kontemporer "RuangRupa"',
    location: "Galeri Nasional Indonesia, Jakarta",
    posterUrl:
      "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    coverImageUrl:
      "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/09/05 - 2025/09/15",
    timeDisplay: "10:00 - 19:00",
    timezone: "WIB",
    fullDescription:
      "Pameran seni rupa kontemporer yang menampilkan karya-karya terbaru dari seniman muda Indonesia. Instalasi, lukisan, patung, dan seni media baru.",
    ticketCategories: [
      {
        id: "student-pass",
        name: "Pelajar/Mahasiswa",
        price: 25000,
        description: "Wajib menunjukkan kartu pelajar/mahasiswa aktif.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 1000,
        ticketsPurchased: 250,
      },
      {
    ...
    theme: "Pameran Seni",
    address:
      "Jl. Medan Merdeka Tim. No.14, Gambir, Kecamatan Gambir, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10110",
    eventSlug: "ruangrupa-art-exhibition",
    narahubungName: "Kurator Pameran",
    narahubungPhone: "085678901234",
    narahubungEmail: "ruangrupa@artmail.com",
  },
  {
    id: 14,
    category: "B2C",
    name: "Cita Rasa Nusantara Food Festival",
    ...
    coverImageUrl:
      "https://images.unsplash.com/photo-1506368249639-73a05d6f6488?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/09/20 - 2025/09/22",
    timeDisplay: "11:00 - 21:00",
    timezone: "WIB",
    fullDescription:
      "Festival kuliner terbesar yang menyajikan kelezatan hidangan dari seluruh penjuru Nusantara. Lebih dari 100 tenant makanan, demo masak, dan pertunjukan budaya.",
    ticketCategories: [
      {
        id: "entry-voucher-50k",
        name: "Voucher Masuk + Kuliner Rp 50.000",
        price: 50000,
        description: "Termasuk voucher makan senilai Rp 50.000.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 5000,
      ...
      {
        id: "entry-voucher-100k",
        name: "Voucher Masuk + Kuliner Rp 100.000",
        price: 90000,
        description:
          "Termasuk voucher makan senilai Rp 100.000 (Hemat Rp 10.000).",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 3000,
        ticketsPurchased: 800,
      },
    ],
    displayPrice: "Mulai Rp 50.000",
    organizerName: "Hegira Culinary",
    ...
    googleMapsQuery: "Lapangan Banteng Jakarta",
    status: "Aktif",
    theme: "Festival Kuliner",
    address:
      "Ps. Baru, Kecamatan Sawah Besar, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta",
    eventSlug: "cita-rasa-nusantara-fest",
    narahubungName: "Tim Kuliner Hegira",
    narahubungPhone: "081233334444",
    narahubungEmail: "foodfest@hegira.com",
  },
  {
    id: 101,
    category: "B2C",
    name: "Jakarta Culinary Expo 2025", // Event used in dashboard examples
    location: "JIExpo Kemayoran",
    posterUrl:
      "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=60",
    coverImageUrl:
      "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/11/01 - 2025/11/03",
    timeDisplay: "10:00 - 21:00",
    timezone: "WIB",
    fullDescription:
      "Pameran kuliner terbesar se-Asia Tenggara. Menampilkan chef ternama, workshop memasak, dan ratusan tenant makanan lezat.",
    ticketCategories: [
      {
        id: "daily-pass-jce",
        name: "Daily Pass",
    ...
    displayPrice: "Rp 75.000",
    organizerName: "Creator Hegira",
    summary: "Pameran kuliner akbar dengan chef internasional.",
    googleMapsQuery: "JIExpo Kemayoran",
    parkingAvailable: true,
    ageRestriction: "Semua Umur",
    arrivalInfo: "Gunakan pintu masuk Hall C.",
    status: "Aktif",
    theme: "Pameran Kuliner",
    address: "JIExpo Kemayoran, Jakarta Pusat",
    termsAndConditions:
      "Dilarang membawa makanan dari luar. Voucher makanan tersedia.",
    eventSlug: "jakarta-culinary-expo-2025",
    narahubungName: "Creator Hegira",
    narahubungEmail: "info@jce.com",
    narahubungPhone: "+62812FOODFEST",
  },
  {
    id: 15,
    category: "B2C",
    name: "Hegira E-Champions Cup 2025",
    location: "Online & BritAma Arena, Jakarta",
    posterUrl:
      "https://images.unsplash.com/photo-1580234810449-768879425721?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    coverImageUrl:
      "https://images.unsplash.com/photo-1580234810449-768879425721?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=450&q=80",
    dateDisplay: "2025/12/01 - 2025/12/15",
    timeDisplay: "Sesuai Jadwal Pertandingan",
    timezone: "WIB",
    fullDescription:
      "Turnamen e-sport bergengsi yang mempertandingkan game-game populer. Babak kualifikasi online dan grand final offline di BritAma Arena. Total hadiah ratusan juta rupiah!",
    ticketCategories: [
      {
        id: "player-reg",
        name: "Registrasi Pemain (per tim)",
        price: 250000,
        description: "Untuk tim yang ingin berpartisipasi.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 128,
        ticketsPurchased: 60,
      ...
      {
        id: "spectator-online",
        name: "Tiket Nonton Online (Kualifikasi)",
        price: 0,
        description: "Gratis nonton babak kualifikasi via streaming.",
        availabilityStatus: "available",
        useEventSchedule: true,
        maxQuantity: 10000,
      ...
      {
        id: "spectator-venue-gf",
        name: "Tiket Nonton Grand Final (Venue)",
        price: 100000,
        description: "Nonton langsung Grand Final di BritAma Arena.",
        availabilityStatus: "almost-sold",
        useEventSchedule: true,
        maxQuantity: 1000,
        ticketsPurchased: 950,
      },
    ],
    displayPrice: "Gratis / Mulai Rp 100.000",
    organizerName: "Hegira Gaming Division",
    organizerLogoUrl: "/image/hegiralogo.png",
    summary:
      "Turnamen e-sport dengan kualifikasi online dan grand final offline.",
    googleMapsQuery: "BritAma Arena Jakarta",
    status: "Selesai",
    theme: "Turnamen E-Sport",
    address:
      "Jl. Raya Kelapa Nias, Kelapa Gading Tim., Kec. Klp. Gading, Jkt Utara, Daerah Khusus Ibukota Jakarta 14240",
    eventSlug: "hegira-echampions-cup-2025",
    narahubungName: "Panitia E-Sport Hegira",
    narahubungPhone: "089988887777",
    narahubungEmail: "esports@hegira.com",
  },
];
...
=======
    ticketsPurchased:
      tc.ticketsPurchased === undefined
        ? Math.floor(Math.random() * (tc.maxQuantity || 100))
        : tc.ticketsPurchased,
    availabilityStatus: tc.availabilityStatus || "available",
    useEventSchedule:
      tc.useEventSchedule === undefined ? true : tc.useEventSchedule,
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
...
=======
    ticketIsTimeRange:
      tc.ticketIsTimeRange === undefined ? true : tc.ticketIsTimeRange,
    ticketTimezone: tc.ticketTimezone || "",
  })),
}));
...
const HegiraApp: React.FC = () => {
  ...
  const [currentConfirmationTarget, setCurrentConfirmationTarget] =
  ...
  const [isAuthSelectionModalOpen, setIsAuthSelectionModalOpen] =
    useState(false);
  const [authPageToShow, setAuthPageToShow] = useState<
    "login" | "signup" | "otpInput" | "creatorAuth" | null
  >(null);
  const [showOtpModalForVisitor, setShowOtpModalForVisitor] = useState(false);
  const [activeAuthRole, setActiveAuthRole] = useState<AuthRoleType | null>(
    null
  );
  const [userEmailForOtpContext, setUserEmailForOtpContext] = useState("");
  const [userNameForOtpContext, setUserNameForOtpContext] = useState<
    string | undefined
  >(undefined);
  ...
  const [
    ...
    setIsOrganizationVerificationModalOpen,
  ] = useState(false);
...
=======
  const handleNavigateRequestWithConfirmation = useCallback(
    (targetPage: PageName, targetData?: any, resetCallback?: () => void) => {
      let modalTitle = "Konfirmasi Navigasi";
      let modalMessage =
        "Anda memiliki item di keranjang atau data yang belum disimpan. Apakah Anda yakin ingin meninggalkan halaman ini? Perubahan Anda akan hilang.";
      let confirmBtnText = "Ya, Tinggalkan";
      let cancelBtnText = "Tidak, Tetap di Sini";
      let icon: React.ElementType | undefined = AlertTriangle;
      let iconColor = "text-yellow-500";
      ...
      if (
        targetPage === "checkout" &&
        currentConfirmationTarget?.page === "paymentLoading"
      ) {
        modalTitle = "Batalkan Pembayaran?";
        modalMessage =
          "Apakah Anda yakin ingin membatalkan proses pembayaran dan kembali ke halaman checkout? Pesanan Anda belum selesai.";
        confirmBtnText = "Ya, Batalkan";
        iconColor = "text-red-500";
        confirmBtnClass = "bg-red-600 hover:bg-red-700 text-white";
      }
...
=======
  const navigate = useCallback(
    (page: PageName, data?: any) => {
      setIsAppLoading(true);
      setLoadingMessage(
        page === "landing" ? "Kembali ke Beranda..." : `Menuju ${page}...`
      );
...
=======
  ...
  const handleOtpVerificationSuccess = (
    ...
    const roleToSet = activeAuthRole
      ? mapAuthRoleToUserRole(activeAuthRole)
      : "visitor";
    handleLogin(
      roleToSet,
      verifiedName ||
...
=======
      handleLogin(
        newRole,
        newRole === "creator" ? "Kreator Hegira" : "Pengunjung Hegira"
      );
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
      setIsRoleSwitchModalOpen(false);
    }
...
=======
  const handleProcessPayment = (
    formData: TransactionFormData,
    checkoutDataWithFinalPrice: CheckoutInfo
  ) => {
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
...
=======
  ...
  const renderPage = () => {
    if (isAppLoading && currentPage !== "paymentLoading")
    ...
    switch (currentPage) {
      case "landing":
        return (
          <LandingPage
            heroEvents={allEventsData.slice(0, 3)}
            featuredEvents={allEventsData.slice(0, 6)}
            onNavigate={navigate}
      ...
      case "events":
        return (
          <EventPage
            events={allEventsData.filter((e) => e.status === "Aktif")}
            onNavigate={navigate}
          />
        );
      case "business":
        return <BusinessMatchingPage onNavigate={navigate} />;
      case "help":
        return <HelpPage />;
      case "dashboard":
        if (!isLoggedIn || !userRole) {
        ...
        return selectedEvent ? (
          <EventDetailPage
            ...
            onNavigateRequestWithConfirmation={
              handleNavigateRequestWithConfirmation
            }
          />
        ) : (
          <LandingPage
      ...
      case "checkout":
        return checkoutData ? (
          <CheckoutPage
            ...
            eventForBackNav={checkoutData.event}
            onNavigate={navigate}
      ...
      case "paymentLoading":
        return transactionResult ? (
          <PaymentLoadingPage
            ...
            checkoutInfoToReturnTo={transactionResult.checkoutInfo}
          />
        ) : (
          <LandingPage
            heroEvents={allEventsData.slice(0, 3)}
      ...
      case "articlesPage":
        return <ArticleListPage onNavigate={navigate} />;
      case "businessDetail":
        return selectedEvent ? (
          <CompanyDetailPage
            company={selectedEvent as unknown as BusinessMatchingCardData}
            onNavigate={navigate}
          />
        ) : (
          <BusinessMatchingPage onNavigate={navigate} />
        );
      case "creatorAuth":
        if (
          authPageToShow === "otpInput" &&
          activeAuthRole &&
          activeAuthRole !== "Event Visitor"
        ) {
          return null;
        }
        return (
          <CreatorAuthPage
            initialMode="signup"
            onNavigate={navigate}
            onLoginSuccess={(name: string) => handleLogin("creator", name)}
            onSignupSuccess={handleGenericSignupSuccess}
          />
        );
      case "otpInput":
  ...
  const isFullScreenPage =
    pagesWithoutNavFooter.includes(currentPage) ||
    dashboardPages.includes(currentPage) ||
    (authFullScreenPages.includes(currentPage) &&
      authPageToShow === currentPage);
  ...
  const hideFooter =
    ...
    currentPage === "transactionSuccess" ||
    (authPageToShow === "otpInput" && currentPage === "creatorAuth");
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
...
=======
      <div className={!hideNavbar ? "pt-20" : ""}>{renderPage()}</div>
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
      {!hideFooter && (
...
=======
      {authPageToShow === "login" &&
        activeAuthRole &&
        activeAuthRole !== "Event Creator" && (
          <LoginPage
            role={activeAuthRole}
            onLoginSuccess={(role: UserRole) => handleLoginSuccess(role)}
            onClose={handleCloseAuthFlow}
            onSwitchToSignup={handleSwitchToSignup}
          />
        )}

      {authPageToShow === "signup" &&
        activeAuthRole &&
        activeAuthRole !== "Event Creator" && (
          <SignupPage
            role={activeAuthRole}
...
=======
          onVerifySuccess={(verifiedEmail: string) =>
            handleOtpVerificationSuccess(verifiedEmail)
          }
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
          onResendOtp={handleResendOtp}
          onChangeEmail={handleChangeEmailForOtp}
...
=======
      {authPageToShow === "otpInput" &&
        activeAuthRole &&
        activeAuthRole !== "Event Visitor" &&
        userEmailForOtpContext &&
        currentPage !== "otpInput" && (
          <OtpInputPage
>>>>>>> 9d6e35a8089e767e27e085b51a51b23558e643ec
            email={userEmailForOtpContext}
            userName={userNameForOtpContext}
