...
const hegiraBaseIcon = L.Icon.extend({
  options: {
...
const hegiraTurquoiseIcon = new hegiraBaseIcon({ iconUrl: 'https://img.icons8.com/ios-filled/50/4b998e/marker.png' }); // Turquoise color
const hegiraYellowIcon = new hegiraBaseIcon({ iconUrl: 'https://img.icons8.com/ios-filled/50/ebaf4c/marker.png' }); // Yellow for active
    ...
    if (mapRef.current && markersRef.current) {
      ...
      vendors.forEach(vendor => {
        if (vendor.lat && vendor.lng) {
          const iconToUse = vendor.id === activeVendorId ? hegiraYellowIcon : hegiraTurquoiseIcon;
