...
const PortfolioCarousel: React.FC<PortfolioCarouselProps> = ({ projects }) => {
  ...
  if (!projects || projects.length === 0) {
    return (
         <section aria-labelledby="portfolio-title" className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            <h2 id="portfolio-title" className="text-xl font-semibold text-hegira-deep-navy mb-4">Portofolio Proyek</h2>
  ...
  return (
    <section aria-labelledby="portfolio-title" className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
      <h2 id="portfolio-title" className="text-xl font-semibold text-hegira-deep-navy mb-4">
      ...
      <div className="relative group">
        ...
        <h3 className="text-md font-semibold text-hegira-deep-navy/90 mt-3 mb-1 line-clamp-1" title={currentProject.title}>{currentProject.title}</h3>
        ...
        {projects.length > 1 && (
            ...
            <div className="flex justify-center space-x-1.5 mt-2">
                ...
                <button
                    ...
                    ${ currentIndex === index ? 'bg-hegira-turquoise scale-125' : 'bg-gray-300 hover:bg-gray-400'}`}
