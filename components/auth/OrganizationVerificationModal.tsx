...
const OrganizationVerificationModal: React.FC<OrganizationVerificationModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[102] flex items-center justify-center bg-hegira-auth-background/80 backdrop-blur-md p-4 animate-fade-in"
      ...
      <div className="relative bg-hegira-white w-full max-w-md rounded-2xl shadow-2xl border border-hegira-navy/10 overflow-hidden transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear">
        ...
        <div className="p-6 sm:p-8">
          <div className="text-center mb-6">
            ...
            <h1 id="org-verification-modal-title" className="text-xl sm:text-2xl font-semibold text-hegira-navy">
              {contextText}
            </h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={`w-full py-2.5 pl-10 pr-3 bg-white border rounded-lg shadow-sm focus:ring-1 focus:ring-hegira-turquoise transition-colors placeholder-gray-400 text-sm ${error ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold 
                           text-white bg-hegira-yellow hover:bg-yellow-400 
                           focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-hegira-navy
          ...
          <p className="mt-6 text-center text-xs text-gray-500">
            Belum memiliki kode verifikasi atau butuh bantuan? Hubungi <a href="mailto:support@hegira.com" className="text-hegira-turquoise hover:underline">Dukungan Hegira</a>.
          </p>
        </div>
      </div>
      <style>{`
