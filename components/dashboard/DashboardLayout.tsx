...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar for Desktop */}
      <div className={`hidden md:flex flex-col transition-all duration-300 ease-in-out ${isDesktopSidebarOpen ? 'w-64' : 'w-20'} bg-hegira-white shadow-lg`}>
        <DashboardSidebarNav
      ...
      <div className={`fixed inset-y-0 left-0 z-50 flex flex-col w-64 bg-hegira-white shadow-xl transition-transform duration-300 ease-in-out md:hidden ${isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
         <DashboardSidebarNav
          sidebarSections={sidebarSections}
