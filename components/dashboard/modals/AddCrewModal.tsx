  ...
  return (
    ...
    >
      <div className="bg-white text-hegira-navy p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-lg relative transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear max-h-[90vh] overflow-y-auto custom-scrollbar-modal">
        ...
        <h2 id="add-crew-modal-title" className="text-xl sm:text-2xl font-semibold text-hegira-navy mb-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" name="name" id="crew-name" value={formData.name} onChange={handleInputChange} required
                     className={`w-full py-2.5 pl-9 pr-3 bg-white border rounded-lg shadow-sm focus:ring-1 focus:ring-hegira-turquoise transition-colors placeholder-gray-400 text-sm ${formErrors.name ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <label htmlFor="crew-role" className="block text-sm font-medium text-gray-700 mb-1">Role/Posisi <span className="text-red-500">*</span></label>
             <div className="relative">
              ...
              <input type="text" name="role" id="crew-role" value={formData.role} onChange={handleInputChange} required
                     className={`w-full py-2.5 pl-9 pr-3 bg-white border rounded-lg shadow-sm focus:ring-1 focus:ring-hegira-turquoise transition-colors placeholder-gray-400 text-sm ${formErrors.role ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div className="relative flex items-stretch w-full mt-1">
              <div className="relative">
                <select 
                  ...
                  className="appearance-none z-10 h-full block w-auto py-2.5 pl-3 pr-8 text-sm border border-r-0 border-gray-300 rounded-l-lg focus:ring-2 focus:ring-hegira-turquoise/20 focus:border-hegira-turquoise/50 bg-white"
              ...
              <div className="relative flex-grow">
                ...
                <input 
                  ...
                  className={`w-full py-2.5 pl-9 pr-3 bg-white border rounded-r-lg shadow-sm focus:ring-1 focus:ring-hegira-turquoise transition-colors placeholder-gray-400 text-sm ${formErrors.phoneNumber ? 'border-red-500' : 'border-gray-300'}`}
