...
const DeleteCrewModal: React.FC<DeleteCrewModalProps> = ({
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="bg-white text-hegira-navy p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-md relative transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear">
        <button
          onClick={onClose}
        ...
        <div className="flex items-start">
            ...
            <div className="flex-grow">
                <h2 id="delete-crew-modal-title" className="text-xl font-semibold text-hegira-navy">
                Konfirmasi Hapus Crew
                </h2>
                <p className="text-sm text-gray-600 mt-2">
                Anda yakin ingin menghapus anggota crew <strong className="text-hegira-deep-navy">{crewMemberName}</strong>? Tindakan ini tidak dapat diurungkan.
                </p>
            </div>
        </div>
