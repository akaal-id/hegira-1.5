...
const CrewIDCardModal: React.FC<CrewIDCardModalProps> = ({ isOpen, onClose, crewMembers, eventData }) => {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="bg-white text-hegira-navy p-5 sm:p-6 rounded-xl shadow-2xl w-full max-w-4xl relative transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center pb-3 border-b border-gray-200 mb-4">
          <h2 id="crew-id-card-modal-title" className="text-lg font-semibold text-hegira-deep-navy flex items-center">
            <QrCode size={20} className="mr-2 text-hegira-turquoise" /> Kartu ID Crew - Event: {eventData.name}
          </h2>
      ...
      <style>{`
        ...
        .custom-scrollbar-modal-outer::-webkit-scrollbar-thumb { background: var(--hegira-chino, #d0cea9); border-radius: 10px; }
