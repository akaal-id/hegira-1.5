...
const EventCardDB: React.FC<EventCardDBProps> = ({
  ...
  return (
    <div 
      className="bg-white rounded-lg border border-gray-200 hover:border-hegira-turquoise/30 overflow-hidden transition-all duration-300 group flex flex-col h-full"
      role="article" 
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-grow"> {/* Standardized padding */}
        ...
        <div className="flex justify-between items-center mb-2">
          <h3 
            ...
            className="text-lg font-semibold text-hegira-deep-navy group-hover:text-hegira-turquoise transition-colors duration-200 truncate flex-grow mr-2" 
            title={name}
          >
            {name}
          </h3>
        ...
        <div className="mt-auto pt-3 text-center">
          <button
            ...
            className="text-sm font-semibold text-hegira-turquoise hover:text-hegira-yellow transition-colors duration-200 py-1 group/button inline-flex items-center"
