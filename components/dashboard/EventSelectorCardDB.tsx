...
const EventSelectorCardDB: React.FC<EventSelectorCardDBProps> = ({ eventData, onSelectEvent }) => {
  ...
  return (
    <div
      className="bg-white rounded-lg border border-gray-200 hover:border-hegira-turquoise/40 overflow-hidden transition-all duration-300 group flex flex-col h-full shadow-sm hover:shadow-md"
      role="button"
      tabIndex={0}
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        <h3
          ...
          className="text-md font-semibold text-hegira-deep-navy group-hover:text-hegira-turquoise transition-colors duration-200 mb-2 truncate"
          title={name}
        >
          {name}
        </h3>
        ...
        <button
          ...
          className="mt-auto w-full bg-hegira-turquoise/10 text-hegira-turquoise font-semibold py-2 px-3 rounded-md
                     hover:bg-hegira-turquoise/20 transition-colors duration-200
